...
if [ -t 0 ]; then
  ...
  a=""; ask "E16 конец стадии (зона 024): бонус по числу жизней, +1 жизнь, сброс костюма, 10000 за смелость и таймер?" "полная последовательность ORIGINAL_MECHANICS.md:140-146; до wave-D начисляются только жизни и refill"; read -r a; record E16 "$a"
